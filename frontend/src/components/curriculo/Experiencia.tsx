export default function Experiencia() {
    return (
        <div className="flex flex-col sm:flex-row lg:flex-col items-center justify-around gap-6 p-6 bg-black border border-zinc-800 rounded-2xl">
            <Item principal="+9" label="anos de experiência" />
            <Item principal="+10" label="projetos arquitetados" />
            <Item principal="+30" label="projetos legados (sustentação)" />
            <Item principal="+1kkk" label="de pessoas impactadas" />
        </div>
    )
}
